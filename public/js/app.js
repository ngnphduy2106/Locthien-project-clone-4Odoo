...
(function () {
    ...
    function reportError(msg, source, line, col, stack) {
        ...
        if (String(msg).includes('ServiceWorker') || String(msg).includes('service worker')) return;
        _errCount++;
        try {
            ...
            <div style="margin-top:24px; border-top:1px solid var(--border); padding-top:16px;">
                ...
                <div style="margin-top:12px;">
                    <label style="display:inline-flex; align-items:center; gap:8px; padding:8px 16px; background:var(--success); color:white; border-radius:8px; cursor:pointer; font-size:13px;">
                        ...
                        <input type="file" accept="image/jpeg,image/png" multiple onchange="handleAddProofImages(this, '${order.soDon || order.sale_order_no || order.id}')" style="display:none;">
                    </label>
            ...
            <div style="margin-top:24px; border-top:1px solid var(--border); padding-top:16px;">
                ...
                <div style="display:flex; gap:8px; align-items:flex-end;">
                    ...
                    <label class="btn btn-outline" style="cursor:pointer; padding:8px 12px;">
                        ...
                        <input type="file" id="chatImageInput" accept="image/jpeg,image/png" onchange="previewChatImage(this)" style="display:none;">
                    </label>
        ...
        modalBody.innerHTML = `
            ...
            <div class="form-group">
                ...
                <label style="display:inline-flex; align-items:center; gap:8px; padding:8px 16px; background:var(--success); color:white; border-radius:8px; cursor:pointer; font-size:13px;">
                    ...
                    <input type="file" id="inp-del-img" accept="image/jpeg,image/png" multiple onchange="handleImageSelect(this)" style="display:none;">
                </label>
                <span style="margin-left:8px; font-size:12px; color:var(--text-muted);">Tối đa 10 ảnh</span>
            </div>
    ...
    if (modalBody) {
        modalBody.innerHTML = `
            ...
            <div class="form-group">
                ...
                <label style="display:inline-flex; align-items:center; gap:8px; padding:8px 16px; background:var(--success); color:white; border-radius:8px; cursor:pointer; font-size:13px;">
                    <i class="bi bi-plus-circle"></i> Thêm ảnh
                    <input type="file" id="inp-import-del-img" accept="image/jpeg,image/png" multiple onchange="handleImportImageSelect(this)" style="display:none;">
                </label>
                <span style="margin-left:8px; font-size:12px; color:var(--text-muted);">Tối đa 10 ảnh</span>
            </div>
        ...
        modalBody.innerHTML = `
            ...
            <div style="margin-top:24px; border-top:1px solid var(--border); padding-top:16px;">
                ...
                <label style="display:inline-flex; align-items:center; gap:8px; margin-top:12px; padding:8px 16px; background:var(--primary); color:white; border-radius:8px; cursor:pointer; font-weight:500; font-size:13px;">
                    <i class="bi bi-plus-circle"></i> Thêm ảnh
                    <input type="file" accept="image/jpeg,image/png" multiple onchange="handleAddImportProofImages(this, '${imp.id}')" style="display:none;">
                </label>
                ` : ''}
            </div>
        ...
        modalBody.innerHTML = `
            ...
            <div style="margin-bottom:20px;">
                ...
                <label style="display:inline-flex; align-items:center; gap:8px; margin-top:12px; padding:10px 16px; background:var(--primary); color:white; border-radius:8px; cursor:pointer; font-weight:500;">
                    ...
                    <input type="file" accept="image/jpeg,image/png" multiple onchange="handleCompletionImagesSelect(this)" style="display:none;">
                </label>
...
async function loadPendingConfirmOrders() {
    ...
    try {
        ...
        if (confirmCurrentTab === 'export') {
            ...
            // Group merged orders together for visual clarity
            const mergedGroups = {};
            const standaloneOrders = [];
            
            for (const o of orders) {
                if (o.merged_order_no) {
                    if (!mergedGroups[o.merged_order_no]) mergedGroups[o.merged_order_no] = [];
                    mergedGroups[o.merged_order_no].push(o);
                } else {
